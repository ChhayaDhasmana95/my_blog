...
p4.comments.create(body: "This post was the best thing in the whole world", user: u1)# This file should contain all the record creation needed to seed the database with its default values.
